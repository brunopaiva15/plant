...
- Relevé de la maison au LiDAR (RoomPlan, iPhone Pro) : où poser une plante, par pièce, d'après la distance et l'orientation des fenêtres — palier 1 codé derrière `--dart-define=ROOM_SCAN=true` (canal, modèle de lumière calibré sur le diorama, écrans), à valider sur un appareil ; la suite dans [docs/17-releve-de-la-maison.md](17-releve-de-la-maison.md)
