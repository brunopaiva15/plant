...
- Relevé de la maison au LiDAR (RoomPlan, iPhone Pro) : où poser une plante, par pièce, d'après la distance et l'orientation des fenêtres — paliers 1 et 2 codés derrière `--dart-define=ROOM_SCAN=true` (canal, modèle de lumière calibré sur le diorama, radiateurs, latitude, « Qui serait bien ici », capteur de la pièce, emplacement renseigné), validés sur un iPhone Pro ; la suite dans [docs/17-releve-de-la-maison.md](17-releve-de-la-maison.md)
