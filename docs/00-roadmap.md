...
- Relevé de la maison au LiDAR (RoomPlan, iPhone et iPad à LiDAR) : où poser une plante, par pièce, d'après la distance et l'orientation des fenêtres — livré (canal, modèle de lumière calibré sur le diorama, radiateurs, latitude, « Le jardin dans cette pièce », capteur de la pièce, emplacement renseigné, appartement entier par `StructureBuilder`, plantes posées sur le plan et « Poser ici », rideaux par fenêtre, balcon, section de sauvegarde) ; les deux premiers validés sur un iPhone Pro, le troisième attend son relevé réel ; la suite dans [docs/17-releve-de-la-maison.md](17-releve-de-la-maison.md)
