...
do $$ declare t text; begin
  foreach t in array array['gardens','locations','plants','care_schedules','inventory_items','tasks'] loop
...
do $$ declare t text; begin
  foreach t in array array['locations','plants','tags','inventory_items','tasks'] loop
