...
void main() {
  ...
  test('catalogue : ce que le modèle livré ne sait pas nommer, compté', () {
    ...
    expect(curatees, hasLength(1453));
    expect(
      muettes,
...
/// Mesuré sur Iris Indoor : 1 139 des 1 453 fiches curatées n'ont pas de classe
/// dans le modèle livré, qui en nomme 314. Le plafond n'interdit pas d'en
