...
void main() {
  ...
  test('liste les capteurs avec leur pièce', () async {
    answer((call) => [
  ...
  test("l'accès se traduit mot pour mot", () async {
    ...
    expect(HomeKitClimateService.parseAccess('authorized'), HomeAccess.authorized);
    expect(HomeKitClimateService.parseAccess('notDetermined'), HomeAccess.notDetermined);
    expect(HomeKitClimateService.parseAccess('?'), HomeAccess.unavailable);
  });
