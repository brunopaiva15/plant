...
void main() {
  ...
  test('a list worth showing stops the cascade without a remote call', () {
    ...
    // 0,60 : sous le seuil d'acceptation, au-dessus du plancher. Cette valeur
    // suit le recalibrage à chaque version — 0,60 pour la v5, 0,50 pour la
    // v6, 0,60 de nouveau depuis qu'Iris 7 a fait remonter le seuil à 0,70.
    // C'est le calibrage qui bouge, pas l'intention du test.
    expect(policy.decide([c('Monstera deliciosa', 0.60), c('Monstera adansonii', 0.05)]), IdentificationVerdict.plausible);
    expect(policy.decide([c('Monstera deliciosa', 0.70), c('Monstera adansonii', 0.05)]), IdentificationVerdict.accepted,
