...
| [docs/13-fiabilite-des-fiches.md](docs/13-fiabilite-des-fiches.md) | Fiabilité des fiches d'entretien : ce que l'héritage espèce → genre → famille laisse passer, et le plan pour le corriger |
