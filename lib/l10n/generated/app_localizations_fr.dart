...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String identificationHint(String name) {
    return '$name reconnaît les espèces directement sur votre appareil, sans réseau. Quand il hésite, la photo peut être envoyée à Pl@ntNet pour trancher.';
  }
  ...
  String irisTwoPhotosBody(String name) {
    return 'Photographiez la plante entière, puis une feuille de près. Avec deux photos, $name trouve la bonne espèce deux fois sur trois, au lieu d’une fois sur deux.';
  }
  ...
  String weatherRainSkip(String names) {
    return 'Pas besoin d\'arroser $names aujourd\'hui, la pluie s\'en charge.';
  }
  ...
  @override
  String get whatsNewIrisDoubtTitle => 'Il sait dire qu\'il hésite';
  ...
  @override
  String get photoFirstTitle => 'Sa première photo';

  @override
  String get photoNextTitle => 'Une nouvelle photo';
  ...
  @override
  String get photoGhostToggle => 'Calquer la dernière photo';
  ...
  @override
  String get photoTitleStepTitle => 'Un titre ?';
  ...
  @override
  String get mainPhotoHint => 'Celle de la fiche et de la liste.';
  ...
  String growthNudge(String date) {
    return 'Dernière photo le $date. Une nouvelle ?';
  }
  ...
  @override
  String get stepPhotoDoneTitle => 'La voilà.';

  @override
  String stepPhotoDoneSubtitle(String name) {
    return 'Une feuille de près aiderait $name à reconnaître l\'espèce. Facultatif.';
  }
  ...
  @override
  String get viewPlant => 'Sa photo';

  @override
  String get viewLeafClose => 'Une feuille de près';

  @override
  String get viewAnother => 'Une autre vue';

  @override
  String viewForModel(String name) {
    return 'Pour aider $name à trancher. Cette vue ne sera pas gardée.';
  }

  @override
  String viewsCaption(String name) {
    return 'Vues pour $name, effacées ensuite';
  }
}
