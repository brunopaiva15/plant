...
/// - le modèle embarqué répartit sa masse sur les quelques milliers d'espèces
///   qu'il expose — leur nombre exact est dans `assets/model/model.json`, il
///   change à chaque version — et Pl@ntNet sur des dizaines de milliers. À
///   confiance réelle égale, le premier sort des scores structurellement
///   plus hauts. Les afficher dans la même colonne
