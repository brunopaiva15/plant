...
/// règle par App Attest : voir `core/network/relay_client.dart`.
abstract final class RelayConfig {
  ...
  /// Integrity. Ce n'en est pas moins un secret partagé — il n'a rien à faire
  /// dans une construction publiée, et le relais le coupe d'un
